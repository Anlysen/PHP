...
$alpha = [];
$rand = rand(5, 10);
for ($a = 0; $a <= $rand; $a++) { // Создание массив со случайным количеством элементов от 5 до 10
    $alpha[] = rand(0, 100);      // Элементы которого принимают случайное значение от 0 до 100. 
}
sort($alpha);
echo "<pre>";
print_r($alpha); // Сортировка массива по возрастанию
echo "</pre>";
